...
class WinCCUnifiedClient {
  ...
  HttpOverrides? _originalHttpOverrides;
  ...
  Future<Map<String, dynamic>> _makeRequest(String query, Map<String, dynamic> variables) async {
    ...
    if (ignoreSslCertificateErrors && client != null) {
      client.close();
    }
